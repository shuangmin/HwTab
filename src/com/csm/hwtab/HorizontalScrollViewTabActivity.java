...
import com.csm.hwtab.TabHorizontalScrollView.OnTabOperatorListener;
...
public class HorizontalScrollViewTabActivity extends FragmentActivity implements OnTabOperatorListener {
	private ViewPager mViewPager;
	private TabHorizontalScrollView mTabview;
	int mCount = 1;
	...
	private void initTabsView() {
		...
		mTabview = (TabHorizontalScrollView)findViewById(R.id.tab);
